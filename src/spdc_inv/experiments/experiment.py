...
if __name__ == "__main__":
    ...
    interaction_params = {
        ...
        'custom_pump_coefficient': {REAL: {0: 0., 1: 0., 2: 0., 3: 0., 4: 1., 5: 0., 6: 0., 7: 0.},
                                    IMAG: {0: 0., 1: 0., 2: 0.}},
        ...
        'dk_offset': 1.003,  # np.cos(2*np.pi/180)*0.98
        'power_signal': 1.,
        'power_idler': 1.,
    }

    projection_params = {
        'coincidence_projection_basis': 'Fourier',
